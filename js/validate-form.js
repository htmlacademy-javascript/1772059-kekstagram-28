...
const initValidator = () => {
  ...
  pictureForm.addEventListener('submit', initPristine);
};

const resetValidator = () => pictureForm.removeEventListener('submit', initPristine);

export { initValidator, resetValidator };
